...
int main(int argc, char* argv[])
{
    ...
    std::string_view cert_path = config["server"]["cert_path"].value_or("");
    std::string_view key_path = config["server"]["key_path"].value_or("");
    std::string_view cert_node_path = config["node"]["cert_path"].value_or("");
    std::string_view key_node_path = config["node"]["key_path"].value_or("");
